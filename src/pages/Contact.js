  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_hq7snzd', 'template_b8nht2f', form.current, 'feHkisclE7WJWJdBw')
      .then((result) => {
          ...
          toast.success('mail sent to sudhankumar524@gmail.com 🙂', {
            position: "top-right",
            autoClose: 5000,
          ...
          // toast("mail sent to sudhankumar524@gmail.com");
      }, (error) => {
          console.log(error.text);
          toast.error('Unable to send email try after sometime 🙃', {
            position: "top-right",
            autoClose: 5000,
            hideProgressBar: false,
            closeOnClick: true,
    ...
    <div className='container-fluid contactbg'>
        <div className='contact bg-dark'>
            <form className=' mx-auto' ref={form} onSubmit={sendEmail} method='post' id='Form'>
                <h1 className='my-4 text-warning'>Build a Network!</h1>
